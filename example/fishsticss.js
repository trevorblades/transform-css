...
var Fishsticss = function Fishsticss(options) {
  return {
    scrub: function scrub(css) {
      ...
      while (match) {
        ...
        if (selectors[selector]) {
          selectors[selector].rules = (0, _assign2.default)(selectors[selector].rules, rules);
        } else {
...
},{"babel-runtime/core-js/object/assign":1}]},{},[16])


//# sourceMappingURL=fishsticss.js.map
